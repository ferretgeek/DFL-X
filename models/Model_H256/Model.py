...
class Model(ModelBase):
    ...
    def onInitialize(self):
        ...
        self.ae.compile(optimizer=Adam(lr=5e-5, beta_1=0.5, beta_2=0.999, tf_cpu_mode=self.options['optimizer_mode']-1),
        ...
        if self.is_training_mode:
            ...
            output_sample_types=[ { 'types': (t.IMG_WARPED_TRANSFORMED, t.FACE_TYPE_HALF, t.MODE_BGR), 'resolution':256},
                                  { 'types': (t.IMG_TRANSFORMED, t.FACE_TYPE_HALF, t.MODE_BGR), 'resolution':256},
                                  { 'types': (t.IMG_TRANSFORMED, t.FACE_TYPE_HALF, t.MODE_M), 'resolution':256} ]
    ...
    def onGetPreview(self, sample):
        ...
        return [ ('H256', np.concatenate ( st, axis=0 ) ) ]
